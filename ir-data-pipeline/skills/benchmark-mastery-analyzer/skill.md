...
description: >
  This skill should be used when "analyzing FAST PM results" or "identifying benchmark mastery gaps" for 10th grade ELA. Use when "planning instruction around specific benchmarks", "correlating FAST and NWEA data", or "creating flexible groups based on benchmark performance".
version: 0.1.0
---
...
- **R.1.3**: Character development & interactions
- **R.1.4**: Figurative language & tone

### Informational Text Benchmarks (ELA.10.R.2.x) → Reading Informational Text
- **R.2.1**: Central idea & objective summary
- **R.2.2**: Text structure & text features
...
- **R.3.4**: Word choice (diction), tone, mood
...
WEAKNESSES (Top 3):
1. ELA.10.R.2.1 (Central idea): 33% ⚠️ DEVELOPING
...
- Target R.2.1 (central idea) and R.2.3 (author's purpose) to strengthen foundation
...
1. ELA.10.R.1.4 (Figurative language & tone): 86% proficient (12/14 students)
2. ELA.10.R.3.4 (Word choice, tone, mood): 79% proficient (11/14 students)
3. ELA.10.V.1.3 (Context clues): 71% proficient (10/14 students)

DEVELOPING BENCHMARKS (40-69% of class proficient):
4. ELA.10.R.1.3 (Character development): 64% proficient (9/14 students)
5. ELA.10.R.2.2 (Text structure): 57% proficient (8/14 students)
6. ELA.10.V.1.2 (Morphology): 57% proficient (8/14 students)

WEAK BENCHMARKS (<40% of class proficient):
7. ELA.10.R.2.1 (Central idea): 36% proficient (5/14 students) ⚠️ PRIORITY
...
3. MEDIUM PRIORITY: ELA.10.R.2.1 (Central idea) - 64% need intervention
...
Students Strong in Theme (R.1.2) but Weak in Central Idea (R.2.1):

CHARLES, HUDSON:
- Theme (R.1.2): 100%
- Central Idea (R.2.1): 0%
...
Students Strong in Central Idea (R.2.1) but Weak in Theme (R.1.2):

BONNET, CHRISTY:
- Central Idea (R.2.1): 75%
- Theme (R.1.2): 0%
...
3. ELA.10.R.2.1 (Central idea): 36% proficient
...
Weeks 5-6: Central Idea in Nonfiction (addresses R.2.1)
- Focus Benchmark: ELA.10.R.2.1
...
- Small-group focus on R.1.2, R.2.4, R.2.1
...
**Example**: Pair student strong in R.1.2 (Theme) with student strong in R.2.1 (Central idea) to teach each other.
...
**Week 5-6**: Focus on R.2.1 (Central idea), spiral theme and argument
