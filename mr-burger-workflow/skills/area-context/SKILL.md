...
name: area-context
description: >
  This skill should be used when determining which life area a task or note
  belongs to, or when needing context about the user's projects and file locations.
  Use when routing content or providing area-specific context.
version: 1.0.0
---
...
- Notes: `~/Desktop/SecondBrain/notes/teaching/`
...
- Claude Code teaching skills (30+) and agents (19+)
...
**Primary Files & Locations**:
- Main folders: `~/Documents/Career/` and `~/Desktop/Job Hunting/`
- Notes: `~/Desktop/SecondBrain/notes/career/`
...
- **Constraints**: Must align with school year / need flexibility during school year
...
- Notes: `~/Desktop/SecondBrain/notes/music/`
...
**Primary Files & Locations**:
- Main folders: `~/Documents/Dog-Training/` and `~/Desktop/Susan Garrett/`
- Notes: `~/Desktop/SecondBrain/notes/dog-training/`
...
- HSTD (likely "Handling Skills Teaching Dogs" or similar): Planned course
- Building Olive's foundation skills using Susan Garrett framework

**Context**:
- **Dog**: Olive (name and type not yet specified in full detail)
...
**Primary Files & Locations**:
- Main folders: `~/Documents/Personal/` and `~/Desktop/Personal-Documents/`
- Notes: `~/Desktop/SecondBrain/notes/personal/`
...
- **Interests**: Teaching, tech, music, dogs, personal growth
...
- Notes: `~/Desktop/SecondBrain/notes/tech/`
- File types: code, configs, plugin documentation, GitHub project notes, keyboard setup notes

**Active Projects**:
- Claude Code: Master teaching skills library (30+), agents (19+), hooks
- Cowork productivity plugins: Building personal productivity system plugins (e.g., `mr-burger-workflow`)
- Keyboard configurations: Custom keyboard layouts and automation
- GitHub projects: Teaching tools, personal projects, code samples
- Notion integration: Connector setup (currently on hold, working on file-based system)

**Context**:
- **Expertise**: Claude Code power user, prompt engineering, agent building
- **Tools Used**: Claude Code, Cowork, GitHub, Notion (inactive connector), keyboard automation
- **Focus**: Automation for teaching efficiency, personal productivity plugins, code-based teaching tools
- **Philosophy**: Build systems that reduce manual overhead, automate sync, keep tools simple

**Keywords for Routing**:
- "plugin", "Claude", "code", "GitHub", "JavaScript", "keyboard", "config", "tool", "automation", "Cowork", "agent", "skill"
...
7. **If multiple areas apply**: Tag with the PRIMARY area, but note secondary areas in the content if helpful. Example:
...
| Area | Main Folder | Notes | Plans |
|------|-------------|-------|-------|
| **Teaching** | ~/Documents/Teaching/ | ~/Desktop/SecondBrain/notes/teaching/ | ~/Desktop/SecondBrain/plans/unit-*.md |
| **Career** | ~/Documents/Career/ + ~/Desktop/Job Hunting/ | ~/Desktop/SecondBrain/notes/career/ | ~/Desktop/SecondBrain/plans/job-search-strategy.md |
| **Music** | ~/Documents/Music/ | ~/Desktop/SecondBrain/notes/music/ | Practice logs, song charts |
| **Dog Training** | ~/Documents/Dog-Training/ + ~/Desktop/Susan Garrett/ | ~/Desktop/SecondBrain/notes/dog-training/ | Course tracking, training plans |
| **Personal** | ~/Documents/Personal/ + ~/Desktop/Personal-Documents/ | ~/Desktop/SecondBrain/notes/personal/ | Life plans, health plans |
| **Tech** | ~/Documents/Tech/ | ~/Desktop/SecondBrain/notes/tech/ | ~/Desktop/SecondBrain/plans/plugin-*.md |

---

## Context Summary for Claude

When you're helping Mr. Burger with any request, keep this context in mind:

- **Busy but Organized**: Teaching full-time, job searching, maintaining personal projects (music, dog training, tech)
- **Tool-Savvy**: Power user of Claude Code, Cowork, GitHub, automation
- **Systems-Minded**: Prefers simple, organized systems over complex tools
- **Values**: Efficiency, clarity, minimal context-switching
- **Second Brain Philosophy**: File-based system as source of truth; Notion connector pending
...
- **`/capture`**: Uses area-context to route brain dumps to correct Second Brain locations
- **`/plan`**: Considers area-specific goals and active projects when setting weekly priorities
- **`/review`**: Reflects on progress per area and identifies area-specific blockers
- **`/briefing`**: Organizes daily priorities and open items by area for quick scanning
